...
React.render(React.createElement(DemoThree, null), document.getElementById('demo-three'));
...
module.exports = function (Content, options) {
  ...
  return React.createClass({
    ...
    renderDisplaced: function renderDisplaced() {
      React.render(React.createElement(Content, this.props, this.props.children), container);
    },
